...
public class ArpltnInfoService {
	...
	private String requestApi_getMinuDustWeek() throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=UdaL7AenVanrwxq47rkdDX0dqCdVQbHe%2BSulerknAH4Ym%2FMggfaNVbxMbFvyo52pWP0A6Ave1c0Ep1%2Fc0Df7vw%3D%3D"); /*Service Key*/
...
//			mdwDTO.setFrcstTwoCn(item.get("frcstTwoCn").toString());
//			mdwDTO.setPresnatnDt(item.get("presnatnDt").toString());
//			mdwDTO.setFrcstOneDt(item.get("frcstOneDt").toString());
//			mdwDTO.setFrcstTwoDt(item.get("frcstTwoDt").toString());
