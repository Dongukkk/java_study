...
public class DBMain {
	...
	public static void main(String[] args) {
		...
		/*
		 * int rs1 = deptDAO.saveDept(50, "Manage", "Seoul"); if(rs1 > 0) {
		 * System.out.println("저장이 성공했다~"); }
		 * 
		 * 
		 * Dept newSaveDept = new Dept(); newSaveDept.setDeptno(60);
		 * newSaveDept.setDname("Design"); newSaveDept.setLoc("Busan");
		 * 
		 * 
		 * int rs2 = deptDAO.saveDept(newSaveDept); if(rs2 > 0) {
		 * System.out.println("저장이 성공했다~"); }
		 */
